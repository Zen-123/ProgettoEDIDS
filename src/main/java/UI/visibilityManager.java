    ...
    public void showGameScreen(){
        ...
        switch(ui.mainCharacterButtonPanel.getSelection().getActionCommand()) {
            case "warrior":
                ...
                reference.player.addSpada( new Item("spada",13,5,0,true));
                reference.player.addArmour(new Item("armatura",0,0,5,false));
                reference.player.setHasArmour(true);
                break;
            case "archer":
                reference.player.setMonete(10);
                reference.player.addNum_pozioni(2);
                reference.player.addSpada( new Item("spada",10,3,0,true));
                reference.player.addArmour(new Item("armatura",0,0,1,false));
                reference.player.setHasArmour(true);
                break;
            case "thief":
                ...
                reference.player.addSpada( new Item("spada",8,4,0,true));
                reference.player.addArmour(new Item("armatura",0,0,0,false));
                reference.player.setHasArmour(true);
                break;
            default:
                break;
