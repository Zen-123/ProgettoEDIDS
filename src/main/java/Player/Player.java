...
public class Player extends entity{
    ...
    public void setMoneteLoad(int monete) {
        this.monete = monete;
    }
    ...
    public void setSpadaName(String nome) {
        this.spada.nome = nome;
    }
    ...
    public void setArmourName(String nome) {
        this.armatura.nome = nome;
    }
    ...
    public void setMaxDamage(int maxDamage) {
        this.spada.attacco_max = maxDamage;
    }

    public void setMinDamage(int minDamage) {
        this.spada.attacco_min = minDamage;
    }
}